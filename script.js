...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbw-h8E7xNkz3gfKfbcHFoULkehSbyVeoos_jeMzzqK_QhKVSCJ5ZPQwptwV46zEAsMN/exec";
    ...
    preloadedData.forEach(item => {
        if (!item.isRendered) {
            const marker = new naver.maps.Marker({
                ...
                map: map,
                icon: { content: `<div class="${item.crackdownActive ? 'label-crackdown' : 'label-saved'}">${item.type}</div>`, anchor: new naver.maps.Point(30, 15) }
            });
